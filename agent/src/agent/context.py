...
Choose the workflow by request type:
- Backtest: strategy generation, config/code, run the backtest, summarize metrics, and apply attribution if data is available.
- Swarm team: only when the user explicitly asks for committee or team analysis.
