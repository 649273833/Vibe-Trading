...
class GroundingLedger:
    ...
    def _validate_price_claims(self, content: str) -> list[dict[str, Any]]:
        ...
        for index, line in enumerate(content.splitlines()):
            ...
            for raw_segment in _CLAUSE_SEPARATOR_RE.split(line):
    ...
    def _numbers_without_dates_or_percent(text: str) -> list[float]:
        ...
        # Local additions over upstream: Chinese calendar expressions
        # ("8 月 2 日 0 点") and standalone clock times ("00:00", ISO offsets).
        masked = _CHINESE_DATE_RE.sub(" ", masked)
